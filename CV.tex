...
\begin{document}
	...
	\begin{rSection}{Work experience}
		...
		\longversion{
			\note{
				Developed payment processing system using microservice architecture.
				Worked with AWS SQS, Docker, Terraform, Yandex's internal deployment, continuous integration, version control, monitoring and task tracking systems.
				Also worked with internal analog of Apache Kafka.
			}
		}
